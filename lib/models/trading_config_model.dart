...
class TradingConfigModel {
  ...
  factory TradingConfigModel.fromJson(String str) =>
      TradingConfigModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TradingConfigModel.fromMap(Map<String, dynamic> json) =>
      TradingConfigModel(
        count: json["count"],
        next: json["next"],
        previous: json["previous"],
        results: List<TradingConfig>.from(
            json["results"].map((x) => TradingConfig.fromMap(x))),
      );
...
class TradingConfig {
  ...
  factory TradingConfig.fromJson(String str) =>
      TradingConfig.fromMap(json.decode(str));
